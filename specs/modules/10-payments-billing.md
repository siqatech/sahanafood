...
## API
POST /payments/intents · webhook /payments/callbacks/:provider (firma) · POST /payments/:id/refund · POST /documents (interno desde Ordering/POS) · GET /documents?status · POST /documents/:id/retry · POST /credit-notes.
## Pruebas
